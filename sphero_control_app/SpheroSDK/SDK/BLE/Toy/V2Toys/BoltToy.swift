...
class BoltToy: SpheroV2Toy {
    ...
    func setupLEDArrow(color: UIColor) {
        // Main line
        ...
        self.drawMatrixLine(from: Pixel(x: 2, y: 6), to: Pixel(x: 2, y: 5), color: color)
        self.drawMatrixLine(from: Pixel(x: 5, y: 6), to: Pixel(x: 5, y: 5), color: color)
        self.drawMatrixLine(from: Pixel(x: 1, y: 5), to: Pixel(x: 1, y: 4), color: color)
        self.drawMatrixLine(from: Pixel(x: 6, y: 5), to: Pixel(x: 6, y: 4), color: color)
        self.drawMatrixLine(from: Pixel(x: 0, y: 4), to: Pixel(x: 0, y: 3), color: color)
        self.drawMatrixLine(from: Pixel(x: 7, y: 4), to: Pixel(x: 7, y: 3), color: color)
