...
public final class ToyBox:NSObject {
    ...
    var disconnectedCallback:((CBPeripheral)->())?
    ...
    public func listenForDisconnection(c:@escaping (CBPeripheral)->()){
        self.disconnectedCallback = c
    }
